    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
            <div className="relative overflow-hidden shadow-md pb-80 mb-6">
                <img src={posts.featuredImage.url} alt={posts.title} className='object-top absolute  h-80 w-full object-cover shadow-lg rounded-t-lg lg:rounded-lg' />
            </div>
            ...
            <div className="block lg:flex text-center items-center justify-center mb-8 w-full ">
                ...
                <div className="flex items-center mb-4 text-center justify-center lg:mb-0 w-full lg:w-auto mr-8">
                    <img src={posts.author.photo.url} alt={posts.author.name}
                    height='30px'
                    width='30px'
